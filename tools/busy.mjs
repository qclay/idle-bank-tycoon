...
// Небольшой рост к концу допустим — важно, что он остаётся в единицах действий
// в минуту, а не уходит в сотни, как было, когда сумка росла линейно.
ok('темп не разгоняется по ходу развития', late.всегоДействий <= Math.max(6, mid.всегоДействий * 3),
