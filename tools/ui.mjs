...
ok('соседние помещения тоже ничем не закрыты',
   ['Пункт выдачи', 'Постаматы', 'Касса', 'Сервис'].every((n) => focus.alphas[n] < 0.05),
   JSON.stringify(focus.alphas));
ok('темнота осталась только на складе', focus.alphas['Склад'] > 0.5,
